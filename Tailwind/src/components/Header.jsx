...
export default function Header() {
  return (
    ...
    {/* hidden adress menu that appears on mobile version */}
      <div className="md:hidden container mx-auto flex items-center h-10 px-2 justify-between">
